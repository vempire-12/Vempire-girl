...
cmd({
    ...
    try {
        ...
        await reply("🚀 Updating Vempire-girl Bot...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/vempire-12/Vempire-girl/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "Vempire-girl-main");
